...
@SpringBootTest
class FileTest {
    private FileManagerPlugin fileManagerPlugin = new AliFileManagerPlugin();
    ...
    void test() throws Exception {
        ...
        for (Brand brand : categoryList) {
            try {
                ...
                //上传至第三方云服务或服务器
                brand.setLogo(fileManagerPlugin.inputStreamUpload(inputStream, brand.getId() + ".png", "image/png"));
            } catch (IOException e) {
                log.error("上传你文件出错",e);
            }
        }
